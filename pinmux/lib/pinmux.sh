...
get_json_pkg () {
	...
	###Offline: https://www.ti.com/tool/download/SYSCONFIG/1.18.1.3343
	dl_file="https://dr-download.ti.com/software-development/ide-configuration-compiler-or-debugger/MD-nsUM6f7Vvb/1.18.1.3343/sysconfig-1.18.1_3343-setup.run"
	wfile="sysconfig-1.18.1_3343-setup.run"
